      ...
      def semantic_errors(*args)
        ...
        template.content_tag(:div, html_options) do
          ...
          template.content_tag(:ul, {:class => "error-list"}) do
            FormtasticBootstrap::Helpers::UtilHelper.html_safe(full_errors.map { |error| template.content_tag(:li, FormtasticBootstrap::Helpers::UtilHelper.html_safe(error)) }.join)
          end
        end
      end
    end
