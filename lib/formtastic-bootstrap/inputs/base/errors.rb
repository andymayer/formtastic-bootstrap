    ...
    module Base
      module Errors
        ...
        def error_sentence_html(inline_or_block)
          ...
          template.content_tag(:span, FormtasticBootstrap::Helpers::UtilHelper.html_safe(errors.to_sentence.html_safe), :class => error_class)
        end
        ...
        def error_first_html(inline_or_block = :inline)
          ...
          template.content_tag(:span, FormtasticBootstrap::Helpers::UtilHelper.html_safe(errors.first.untaint), :class => error_class)
        end
